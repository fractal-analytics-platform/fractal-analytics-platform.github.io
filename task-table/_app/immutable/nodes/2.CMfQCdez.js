...
`,type:"compound",authors:"Fractal Core Team",install_instructions:'**How to add this task to a Fractal instance:**\n\nTrigger a PyPI task collection for package `fractal-tasks-core`, package version `1.4.3` and package extras `fractal-tasks`\n\n**How to install this task in a Python environment:**\n\nRun `pip install "fractal-tasks-core[fractal-tasks]==1.4.3"`\n'},{version:"1.4.3",name:"Convert Cellvoyager Multiplexing to OME-Zarr",category:"Conversion",modality:"HCS",tags:["Yokogawa","Cellvoyager","2D","3D"],input_types:{},output_types:{},docs_link:"https://fractal-analytics-platform.github.io/fractal-tasks-core",docs_info:`### Purpose
...
`,type:"compound",authors:"Fractal Core Team",install_instructions:'**How to add this task to a Fractal instance:**\n\nTrigger a PyPI task collection for package `fractal-tasks-core`, package version `1.4.3` and package extras `fractal-tasks`\n\n**How to install this task in a Python environment:**\n\nRun `pip install "fractal-tasks-core[fractal-tasks]==1.4.3"`\n'},{version:"1.4.3",name:"Project Image (HCS Plate)",category:"Image Processing",modality:"HCS",tags:["Preprocessing","3D"],input_types:{is_3D:!0},output_types:{is_3D:!1},docs_link:"https://fractal-analytics-platform.github.io/fractal-tasks-core",docs_info:`### Purpose
...
`,type:"compound",authors:"Fractal Core Team",install_instructions:'**How to add this task to a Fractal instance:**\n\nTrigger a PyPI task collection for package `fractal-tasks-core`, package version `1.4.3` and package extras `fractal-tasks`\n\n**How to install this task in a Python environment:**\n\nRun `pip install "fractal-tasks-core[fractal-tasks]==1.4.3"`\n'},{version:"1.4.3",name:"Illumination Correction",category:"Image Processing",modality:null,tags:["Preprocessing","2D","3D"],input_types:{illumination_corrected:!1},output_types:{illumination_corrected:!0},docs_link:"https://fractal-analytics-platform.github.io/fractal-tasks-core",docs_info:`### Purpose
...
`,type:"parallel",authors:"Fractal Core Team",install_instructions:'**How to add this task to a Fractal instance:**\n\nTrigger a PyPI task collection for package `fractal-tasks-core`, package version `1.4.3` and package extras `fractal-tasks`\n\n**How to install this task in a Python environment:**\n\nRun `pip install "fractal-tasks-core[fractal-tasks]==1.4.3"`\n'},{version:"1.4.3",name:"Cellpose Segmentation",category:"Segmentation",modality:null,tags:["Deep Learning","Convolutional Neural Network","Instance Segmentation","2D","3D"],input_types:{},output_types:{},docs_link:"https://fractal-analytics-platform.github.io/fractal-tasks-core",docs_info:`### Purpose
...
`,type:"parallel",authors:"Fractal Core Team",install_instructions:'**How to add this task to a Fractal instance:**\n\nTrigger a PyPI task collection for package `fractal-tasks-core`, package version `1.4.3` and package extras `fractal-tasks`\n\n**How to install this task in a Python environment:**\n\nRun `pip install "fractal-tasks-core[fractal-tasks]==1.4.3"`\n'},{version:"1.4.3",name:"Calculate Registration (image-based)",category:"Registration",modality:"HCS",tags:["Multiplexing","2D","3D"],input_types:{},output_types:{},docs_link:"https://fractal-analytics-platform.github.io/fractal-tasks-core",docs_info:`### Purpose
...
`,type:"compound",authors:"Fractal Core Team",install_instructions:'**How to add this task to a Fractal instance:**\n\nTrigger a PyPI task collection for package `fractal-tasks-core`, package version `1.4.3` and package extras `fractal-tasks`\n\n**How to install this task in a Python environment:**\n\nRun `pip install "fractal-tasks-core[fractal-tasks]==1.4.3"`\n'},{version:"1.4.3",name:"Find Registration Consensus",category:"Registration",modality:"HCS",tags:["Multiplexing","2D","3D"],input_types:{},output_types:{},docs_link:"https://fractal-analytics-platform.github.io/fractal-tasks-core",docs_info:`### Purpose
...
`,type:"non_parallel",authors:"Fractal Core Team",install_instructions:'**How to add this task to a Fractal instance:**\n\nTrigger a PyPI task collection for package `fractal-tasks-core`, package version `1.4.3` and package extras `fractal-tasks`\n\n**How to install this task in a Python environment:**\n\nRun `pip install "fractal-tasks-core[fractal-tasks]==1.4.3"`\n'},{version:"1.4.3",name:"Napari Workflows Wrapper",category:"Measurement",modality:null,tags:["2D","3D"],input_types:{},output_types:{},docs_link:"https://fractal-analytics-platform.github.io/fractal-tasks-core",docs_info:`### Purpose
...
\`\`\`
`,type:"parallel",authors:"Fractal Core Team",install_instructions:'**How to add this task to a Fractal instance:**\n\nTrigger a PyPI task collection for package `fractal-tasks-core`, package version `1.4.3` and package extras `fractal-tasks`\n\n**How to install this task in a Python environment:**\n\nRun `pip install "fractal-tasks-core[fractal-tasks]==1.4.3"`\n'}]},{pkg_name:"fractal_faim_ipa",version:"0.5.0",task_list:[{version:"0.5.0",name:"FAIM IPA OME-Zarr Converter",category:"Conversion",modality:"HCS",tags:["Molecular Devices","Image Xpress","MD"],input_types:{},output_types:{},docs_link:"https://github.com/fractal-analytics-platform/fractal-faim-ipa",docs_info:`### Purpose
...
`,type:"non_parallel",authors:null,install_instructions:'**How to add this task to a Fractal instance:**\n\nTrigger a PyPI task collection with package `fractal-faim-ipa` and package version `0.5.0`\n\n**How to install this task in a Python environment:**\n\nRun `pip install "fractal-faim-ipa==0.5.0"`\n```\n'}]},{pkg_name:"fractal_lif_converters",version:"0.4.0",task_list:[{version:"0.4.0",name:"Convert Lif Plate to OME-Zarr",category:"Conversion",modality:"HCS",tags:["Leica","Plate converter"],input_types:{},output_types:{},docs_link:"https://github.com/fractal-analytics-platform/fractal-lif-converters",docs_info:`### Purpose
...
`,type:"compound",authors:"Lorenzo Cerrone",install_instructions:'**How to add this task to a Fractal instance:**\n\nTrigger a PyPI task collection with package `fractal-lif-converters` and package version `0.4.0`\n\n**How to install this task in a Python environment:**\n\nRun `pip install "fractal-lif-converters==0.4.0"`\n```\n'},{version:"0.4.0",name:"Convert Lif Scene to OME-Zarr",category:"Conversion",modality:null,tags:["Leica","Single Image Converter"],input_types:{},output_types:{},docs_link:"https://github.com/fractal-analytics-platform/fractal-lif-converters",docs_info:`### Purpose
...
`,type:"compound",authors:"Lorenzo Cerrone",install_instructions:'**How to add this task to a Fractal instance:**\n\nTrigger a PyPI task collection with package `fractal-lif-converters` and package version `0.4.0`\n\n**How to install this task in a Python environment:**\n\nRun `pip install "fractal-lif-converters==0.4.0"`\n```\n'}]},{pkg_name:"operetta_compose",version:"0.2.11",task_list:[{version:"0.2.11",name:"Harmony to OME-Zarr",category:"Conversion",modality:"HCS",tags:["Opera","Operetta","Perkin Elmer"],input_types:{},output_types:{},docs_link:"https://leukemia-kispi.github.io/operetta-compose/",docs_info:`## harmony_to_ome_zarr
Convert TIFFs which were exported from Harmony (Operetta/Opera, Perkin-Elmer) to OME-ZARR
`,type:"non_parallel",authors:"Fabio Steffen",install_instructions:'**How to add this task to a Fractal instance:**\n\nTrigger a PyPI task collection with package `operetta-compose` and package version `0.2.11`\n\n**How to install this task in a Python environment:**\n\nRun `pip install "operetta-compose==0.2.11"`\n```\n'},{version:"0.2.11",name:"Stardist segmentation",category:"Segmentation",modality:null,tags:[],input_types:{},output_types:{},docs_link:"https://leukemia-kispi.github.io/operetta-compose/",docs_info:`## stardist_segmentation
Segment cells with Stardist
`,type:"parallel",authors:"Fabio Steffen",install_instructions:'**How to add this task to a Fractal instance:**\n\nTrigger a PyPI task collection with package `operetta-compose` and package version `0.2.11`\n\n**How to install this task in a Python environment:**\n\nRun `pip install "operetta-compose==0.2.11"`\n```\n'},{version:"0.2.11",name:"Regionprops measurement",category:"Measurement",modality:null,tags:["regionprops","intensity","morphology"],input_types:{},output_types:{},docs_link:"https://leukemia-kispi.github.io/operetta-compose/",docs_info:`## regionprops_measurement
Take measurements using regionprobs and write the features to the OME-ZARR
`,type:"parallel",authors:"Fabio Steffen",install_instructions:'**How to add this task to a Fractal instance:**\n\nTrigger a PyPI task collection with package `operetta-compose` and package version `0.2.11`\n\n**How to install this task in a Python environment:**\n\nRun `pip install "operetta-compose==0.2.11"`\n```\n'},{version:"0.2.11",name:"Feature classification",category:null,modality:null,tags:["napari feature classifier","object classification"],input_types:{},output_types:{},docs_link:"https://leukemia-kispi.github.io/operetta-compose/",docs_info:`## feature_classification
...
`,type:"parallel",authors:"Fabio Steffen",install_instructions:'**How to add this task to a Fractal instance:**\n\nTrigger a PyPI task collection with package `operetta-compose` and package version `0.2.11`\n\n**How to install this task in a Python environment:**\n\nRun `pip install "operetta-compose==0.2.11"`\n```\n'},{version:"0.2.11",name:"Condition registration",category:null,modality:"HCS",tags:["metadata","well conditions","perturbation","treatment"],input_types:{},output_types:{},docs_link:"https://leukemia-kispi.github.io/operetta-compose/",docs_info:"## condition_registration\nRegister the experimental (drug layout) in the OME-ZARR.\nThe table should contain at least the columns `row` and `col` identifying the well.\nIt can have an arbitrary number of additional metadata columns (e.g. drug, concentration, medium, sample).\nDrug combinations can be specified by two entries pointing to the same `row` / `col`\n",type:"parallel",authors:"Fabio Steffen",install_instructions:'**How to add this task to a Fractal instance:**\n\nTrigger a PyPI task collection with package `operetta-compose` and package version `0.2.11`\n\n**How to install this task in a Python environment:**\n\nRun `pip install "operetta-compose==0.2.11"`\n```\n'}]},{pkg_name:"fractal_helper_tasks",version:"0.3.0",task_list:[{version:"0.3.0",name:"Drop T Dimension",category:null,modality:null,tags:["Singleton time dimension"],input_types:{},output_types:{has_t:!1},docs_link:"https://github.com/jluethi/fractal-helper-tasks",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/fractal-analytics-platform/fractal-helper-tasks/releases/download/v0.3.0/fractal_helper_tasks-0.3.0-py3-none-any.whl)
2. Trigger a local task collection by uploading the wheel file

**How to install this task in a Python environment:**

1. Download the wheel file from [this link](https://github.com/fractal-analytics-platform/fractal-helper-tasks/releases/download/v0.3.0/fractal_helper_tasks-0.3.0-py3-none-any.whl)
2. Run \`pip install fractal_helper_tasks-0.3.0-py3-none-any.whl\`
`},{version:"0.3.0",name:"Convert 2D segmentation to 3D",category:null,modality:null,tags:["Mixed modality","2D to 3D workflows"],input_types:{is_3D:!1},output_types:{is_3D:!0},docs_link:"https://github.com/jluethi/fractal-helper-tasks",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/fractal-analytics-platform/fractal-helper-tasks/releases/download/v0.3.0/fractal_helper_tasks-0.3.0-py3-none-any.whl)
2. Run \`pip install fractal_helper_tasks-0.3.0-py3-none-any.whl\`
`},{version:"0.3.0",name:"Rechunk OME-Zarr",category:null,modality:null,tags:["Rechunking","Many files"],input_types:{},output_types:{},docs_link:"https://github.com/jluethi/fractal-helper-tasks",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/fractal-analytics-platform/fractal-helper-tasks/releases/download/v0.3.0/fractal_helper_tasks-0.3.0-py3-none-any.whl)
2. Run \`pip install fractal_helper_tasks-0.3.0-py3-none-any.whl\`
`}]},{pkg_name:"scmultiplex",version:"0.8.5",task_list:[{version:"0.8.5",name:"scMultiplex Calculate Object Linking",category:"Registration",modality:"HCS",tags:["multiplexing","2D"],input_types:{},output_types:{},docs_link:"https://github.com/fmi-basel/gliberal-scMultipleX",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/fmi-basel/gliberal-scMultipleX/releases/download/v0.8.5/scmultiplex-0.8.5-py3-none-any.whl)
2. Trigger a local task collection by uploading the wheel file, with package extras \`fractal-tasks\`

**How to install this task in a Python environment:**

1. Download the wheel file from [this link](https://github.com/fmi-basel/gliberal-scMultipleX/releases/download/v0.8.5/scmultiplex-0.8.5-py3-none-any.whl)
2. Run \`pip install "scmultiplex-0.8.5-py3-none-any.whl[fractal-tasks]"\`
`},{version:"0.8.5",name:"scMultiplex Calculate Linking Consensus",category:"Registration",modality:"HCS",tags:["multiplexing","2D","3D"],input_types:{},output_types:{},docs_link:"https://github.com/fmi-basel/gliberal-scMultipleX",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/fmi-basel/gliberal-scMultipleX/releases/download/v0.8.5/scmultiplex-0.8.5-py3-none-any.whl)
2. Run \`pip install "scmultiplex-0.8.5-py3-none-any.whl[fractal-tasks]"\`
`},{version:"0.8.5",name:"scMultiplex Relabel by Linking Consensus",category:"Registration",modality:"HCS",tags:["multiplexing","2D","3D"],input_types:{},output_types:{},docs_link:"https://github.com/fmi-basel/gliberal-scMultipleX",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/fmi-basel/gliberal-scMultipleX/releases/download/v0.8.5/scmultiplex-0.8.5-py3-none-any.whl)
2. Run \`pip install "scmultiplex-0.8.5-py3-none-any.whl[fractal-tasks]"\`
`},{version:"0.8.5",name:"scMultiplex Calculate Platymatch Registration",category:"Registration",modality:"HCS",tags:["multiplexing","3D"],input_types:{},output_types:{},docs_link:"https://github.com/fmi-basel/gliberal-scMultipleX",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/fmi-basel/gliberal-scMultipleX/releases/download/v0.8.5/scmultiplex-0.8.5-py3-none-any.whl)
2. Run \`pip install "scmultiplex-0.8.5-py3-none-any.whl[fractal-tasks]"\`
`},{version:"0.8.5",name:"scMultiplex Surface Mesh Multiscale",category:"Image Processing",modality:"HCS",tags:["3D","mesh"],input_types:{},output_types:{},docs_link:"https://github.com/fmi-basel/gliberal-scMultipleX",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/fmi-basel/gliberal-scMultipleX/releases/download/v0.8.5/scmultiplex-0.8.5-py3-none-any.whl)
2. Run \`pip install "scmultiplex-0.8.5-py3-none-any.whl[fractal-tasks]"\`
`},{version:"0.8.5",name:"scMultiplex Segment by Intensity Threshold",category:"Segmentation",modality:"HCS",tags:["Classical segmentation","3D"],input_types:{},output_types:{},docs_link:"https://github.com/fmi-basel/gliberal-scMultipleX",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/fmi-basel/gliberal-scMultipleX/releases/download/v0.8.5/scmultiplex-0.8.5-py3-none-any.whl)
2. Run \`pip install "scmultiplex-0.8.5-py3-none-any.whl[fractal-tasks]"\`
`},{version:"0.8.5",name:"scMultiplex Spherical Harmonics from Label Image",category:"Measurement",modality:"HCS",tags:["3D"],input_types:{},output_types:{},docs_link:"https://github.com/fmi-basel/gliberal-scMultipleX",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/fmi-basel/gliberal-scMultipleX/releases/download/v0.8.5/scmultiplex-0.8.5-py3-none-any.whl)
2. Run \`pip install "scmultiplex-0.8.5-py3-none-any.whl[fractal-tasks]"\`
`},{version:"0.8.5",name:"scMultiplex Mesh Measurements",category:"Measurement",modality:"HCS",tags:["3D","mesh","morphology"],input_types:{},output_types:{},docs_link:"https://github.com/fmi-basel/gliberal-scMultipleX",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/fmi-basel/gliberal-scMultipleX/releases/download/v0.8.5/scmultiplex-0.8.5-py3-none-any.whl)
2. Run \`pip install "scmultiplex-0.8.5-py3-none-any.whl[fractal-tasks]"\`
`},{version:"0.8.5",name:"scMultiplex Feature Measurements",category:"Measurement",modality:null,tags:["regionprops","morphology","intensity"],input_types:{},output_types:{},docs_link:"https://github.com/fmi-basel/gliberal-scMultipleX",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/fmi-basel/gliberal-scMultipleX/releases/download/v0.8.5/scmultiplex-0.8.5-py3-none-any.whl)
2. Run \`pip install "scmultiplex-0.8.5-py3-none-any.whl[fractal-tasks]"\`
`},{version:"0.8.5",name:"scMultiplex Expand Labels",category:"Image Processing",modality:null,tags:["2D","3D"],input_types:{},output_types:{},docs_link:"https://github.com/fmi-basel/gliberal-scMultipleX",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/fmi-basel/gliberal-scMultipleX/releases/download/v0.8.5/scmultiplex-0.8.5-py3-none-any.whl)
2. Run \`pip install "scmultiplex-0.8.5-py3-none-any.whl[fractal-tasks]"\`
`},{version:"0.8.5",name:"scMultiplex Calculate Z-Illumination Correction",category:"Image Processing",modality:"HCS",tags:["3D","illumination correction"],input_types:{z_illum_corrected:!1,is_3D:!0},output_types:{},docs_link:"https://github.com/fmi-basel/gliberal-scMultipleX",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/fmi-basel/gliberal-scMultipleX/releases/download/v0.8.5/scmultiplex-0.8.5-py3-none-any.whl)
2. Run \`pip install "scmultiplex-0.8.5-py3-none-any.whl[fractal-tasks]"\`
`},{version:"0.8.5",name:"scMultiplex Apply Z-Illumination Correction",category:"Image Processing",modality:"HCS",tags:["3D","illumination correction"],input_types:{z_illum_corrected:!1,is_3D:!0},output_types:{z_illum_corrected:!0,is_3D:!0},docs_link:"https://github.com/fmi-basel/gliberal-scMultipleX",docs_info:`### Purpose
- Apply z-illumination correction per object in 3D image.
- Task takes as input user-defined channels and z-illumination correction tables,
    and applies correction to the channel images. The channel of the table is matched to the channel of the
    input image based on wavelength id or label. For multiplexing experiments, the user can specify which round(s) and
...
1. Download the wheel file from [this link](https://github.com/fmi-basel/gliberal-scMultipleX/releases/download/v0.8.5/scmultiplex-0.8.5-py3-none-any.whl)
2. Run \`pip install "scmultiplex-0.8.5-py3-none-any.whl[fractal-tasks]"\`
`},{version:"0.8.5",name:"scMultiplex Fuse Touching Labels",category:"Image Processing",modality:null,tags:["2D"],input_types:{},output_types:{},docs_link:"https://github.com/fmi-basel/gliberal-scMultipleX",docs_info:`### Purpose
...
`}]},{pkg_name:"abbott",version:"0.0.12",task_list:[{version:"0.0.12",name:"Compute Registration (elastix)",category:"Registration",modality:"HCS",tags:["Multiplexing"],input_types:{},output_types:{},docs_link:"https://github.com/pelkmanslab/abbott",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.0.12/abbott-0.0.12-py3-none-any.whl)
2. Trigger a local task collection by uploading the wheel file

**How to install this task in a Python environment:**

1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.0.12/abbott-0.0.12-py3-none-any.whl)
2. Run \`pip install abbott-0.0.12-py3-none-any.whl\`
`},{version:"0.0.12",name:"Apply Registration (elastix)",category:"Registration",modality:"HCS",tags:["Multiplexing"],input_types:{registered:!1},output_types:{registered:!0},docs_link:"https://github.com/pelkmanslab/abbott",docs_info:"### Purpose\n- **Applies pre-calculated registration** from `Compute Registration elastix` task to images in an **HCS** OME-Zarr dataset, aligning all acquisitions to a specified reference acquisition.\n- Replaces the non-aligned image with the newly aligned image in the dataset if `overwrite input` is selected.\n- Typically used as the second task in a workflow, following `Calculate Registration (elastix)`.\n\n### Limitations\n- If `overwrite input` is selected, the non-aligned image is permanently deleted, which may impact workflows requiring access to the original images.\n",type:"parallel",authors:"Ruth Hornbachner",install_instructions:`**How to add this task to a Fractal instance:**
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.0.12/abbott-0.0.12-py3-none-any.whl)
2. Run \`pip install abbott-0.0.12-py3-none-any.whl\`
`},{version:"0.0.12",name:"Compute Registration per ROI (elastix)",category:"Registration",modality:"HCS",tags:["Multiplexing"],input_types:{},output_types:{},docs_link:"https://github.com/pelkmanslab/abbott",docs_info:`### Purpose
- **Computes image-based registration** transformations for acquisitions in **HCS** OME-Zarr datasets using the elastix library.
- Needs Elastix profiles to configure the registration.
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.0.12/abbott-0.0.12-py3-none-any.whl)
2. Run \`pip install abbott-0.0.12-py3-none-any.whl\`
`},{version:"0.0.12",name:"Compute Channel Registration (elastix)",category:"Registration",modality:"HCS",tags:["Multiplexing"],input_types:{channels_registered:!1},output_types:{},docs_link:"https://github.com/pelkmanslab/abbott",docs_info:`### Purpose
- **Computes image-based registration** transformations for acquisitions in **HCS** OME-Zarr datasets using the elastix library.
- Needs Elastix profiles to configure the registration.
- Processes images grouped by well, under the assumption that each well contains one image per acquisition.
- Calculates transformations for **specified regions of interest (ROIs)** and stores the results in a registration subfolder per OME-Zarr image.
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.0.12/abbott-0.0.12-py3-none-any.whl)
2. Run \`pip install abbott-0.0.12-py3-none-any.whl\`
`},{version:"0.0.12",name:"Convert Cellvoyager Multiplexing to existing OME-Zarr",category:"Conversion",modality:"HCS",tags:["Yokogawa","Cellvoyager","2D","3D"],input_types:{},output_types:{},docs_link:"https://github.com/pelkmanslab/abbott",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.0.12/abbott-0.0.12-py3-none-any.whl)
2. Run \`pip install abbott-0.0.12-py3-none-any.whl\`
`},{version:"0.0.12",name:"Stardist Segmentation",category:"Segmentation",modality:null,tags:["Deep Learning","Convolutional Neural Network","Instance Segmentation","2D","3D"],input_types:{},output_types:{},docs_link:"https://github.com/pelkmanslab/abbott",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.0.12/abbott-0.0.12-py3-none-any.whl)
2. Run \`pip install abbott-0.0.12-py3-none-any.whl\`
`}]},{pkg_name:"apx_fractal_task_collection",version:"0.4.6",task_list:[{version:"0.4.6",name:"Measure Features",category:"Measurement",modality:null,tags:["Textures","Intensity","Morphology","scikit-image","regionprops"],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Trigger a local task collection by uploading the wheel file

**How to install this task in a Python environment:**

1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Calculate Pixel Intensity Correlation",category:"Measurement",modality:null,tags:["Correlation","Intensity","QC"],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Segment Secondary Objects",category:"Segmentation",modality:"HCS",tags:[],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Expand Labels",category:"Image Processing",modality:null,tags:[],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## init_expand_labels
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Convert IC6000 to OME-Zarr",category:"Conversion",modality:"HCS",tags:["IC6000","IC6K","IN Cell"],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## init_convert_IC6000_to_ome_zarr
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Label Assignment by Overlap",category:"Measurement",modality:null,tags:[],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## init_label_assignment_by_overlap
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Clip Label Image",category:"Image Processing",modality:null,tags:[],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## init_clip_label_image
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Mask Label Image",category:"Image Processing",modality:null,tags:[],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## init_mask_label_image
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Filter Label by Size",category:"Image Processing",modality:null,tags:[],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## init_filter_label_by_size
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Calculate BaSiCPy Illumination Models",category:"Image Processing",modality:null,tags:[],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## init_calculate_basicpy_illumination_models
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Apply BaSiCPy Illumination Models",category:"Image Processing",modality:null,tags:[],input_types:{illumination_corrected:!1},output_types:{illumination_corrected:!0},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## apply_basicpy_illumination_models
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Aggregate Feature Tables",category:"Other",modality:null,tags:[],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## init_aggregate_feature_tables
Initialized clip label image task
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Stitch FOVs with Overlap",category:"Image Processing",modality:null,tags:["Stitching","FOV","Overlap"],input_types:{stitched:!1},output_types:{stitched:!0},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## stitch_fovs_with_overlap
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Multiplexed Pixel Clustering",category:"Measurement",modality:null,tags:["Multiplex","Clustering","Pixel","MCU"],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## multiplexed_pixel_clustering
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Correct Chromatic Shift",category:"Image Processing",modality:null,tags:[],input_types:{chromatic_shift_corrected:!1},output_types:{chromatic_shift_corrected:!0},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## init_correct_chromatic_shift
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Convert Channel to Label",category:"Other",modality:null,tags:[],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## init_convert_channel_to_label
Initialized Filter Label by Size task
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Detect Blob Centroids",category:"Segmentation",modality:null,tags:[],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## init_detect_blob_centroids
Initialized Filter Label by Size task
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Ashlar Stitching and Registration",category:"Image Processing",modality:null,tags:["Stitching","Registration"],input_types:{stitched:!1},output_types:{stitched:!0},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## init_ashlar_stitching_and_registration
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Merge Plate Metadata",category:"Other",modality:null,tags:[],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## merge_plate_metadata
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Normalize Feature Table",category:"Feature Table Processing",modality:null,tags:["Normalization","Feature Table"],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## init_normalize_feature_table
...
1. Download the wheel file from [this link](https://github.com/Apricot-Therapeutics/APx_fractal_task_collection/releases/download/0.4.6/apx_fractal_task_collection-0.4.6-py3-none-any.whl)
2. Run \`pip install apx_fractal_task_collection-0.4.6-py3-none-any.whl\`
`},{version:"0.4.6",name:"Correct 4i Bleaching Artifacts",category:"Feature Table Processing",modality:null,tags:["Correction","Feature Table","4i","Bleaching"],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`## init_correct_4i_bleaching_artifacts
Initializes normalize feature table task
