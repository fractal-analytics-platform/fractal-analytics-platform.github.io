...
`+L),Pe&&qt([W,K,te],H=>{L=Ct(L,H," ")}),d&&J?d.createHTML(L):L},e.setConfig=function(){let S=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};vt(S),bt=!0},e.clearConfig=function(){ve=null,bt=!1},e.isValidAttribute=function(S,u,w){ve||vt({});const O=j(S),V=j(u);return Bt(O,V,w)},e.addHook=function(S,u){typeof u=="function"&&At(F[S],u)},e.removeHook=function(S,u){if(u!==void 0){const w=Ys(F[S],u);return w===-1?void 0:Js(F[S],w,1)[0]}return ea(F[S])},e.removeHooks=function(S){F[S]=[]},e.removeAllHooks=function(){F=oa()},e}var fi=Pa();const mi=[["abbott",[{pkg_name:"abbott",version:"0.1.1",task_list:[{version:"0.1.1",name:"Compute Registration (elastix)",category:"Registration",modality:"HCS",tags:["Multiplexing"],input_types:{},output_types:{},docs_link:null,docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.1.1/abbott-0.1.1-py3-none-any.whl)
2. Run \`pip install abbott-0.1.1-py3-none-any.whl\`
`},{version:"0.1.1",name:"Compute Channel Registration (elastix)",category:"Registration",modality:"HCS",tags:["Multiplexing"],input_types:{channels_registered:!1},output_types:{},docs_link:null,docs_info:`### Purpose
- **Computes image-based registration** transformations for acquisitions in **HCS** OME-Zarr datasets using the elastix library.
- Needs Elastix profiles to configure the registration.
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.1.1/abbott-0.1.1-py3-none-any.whl)
2. Run \`pip install abbott-0.1.1-py3-none-any.whl\`
`},{version:"0.1.1",name:"Convert Cellvoyager Multiplexing to existing OME-Zarr",category:"Conversion",modality:"HCS",tags:["Yokogawa","Cellvoyager","2D","3D"],input_types:{},output_types:{},docs_link:null,docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.1.1/abbott-0.1.1-py3-none-any.whl)
2. Run \`pip install abbott-0.1.1-py3-none-any.whl\`
`},{version:"0.1.1",name:"Stardist Segmentation",category:"Segmentation",modality:null,tags:["Deep Learning","Convolutional Neural Network","Instance Segmentation","2D","3D"],input_types:{},output_types:{},docs_link:null,docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.1.1/abbott-0.1.1-py3-none-any.whl)
2. Run \`pip install abbott-0.1.1-py3-none-any.whl\`
`},{version:"0.1.1",name:"Seeded Watershed Segmentation",category:"Segmentation",modality:null,tags:["scikit-image","itk,","3D"],input_types:{},output_types:{},docs_link:null,docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.1.1/abbott-0.1.1-py3-none-any.whl)
2. Run \`pip install abbott-0.1.1-py3-none-any.whl\`
`},{version:"0.1.1",name:"Upsample Label Image",category:"Image Processing",modality:null,tags:["3D"],input_types:{},output_types:{},docs_link:null,docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.1.1/abbott-0.1.1-py3-none-any.whl)
2. Run \`pip install abbott-0.1.1-py3-none-any.whl\`
`},{version:"0.1.1",name:"Convert abbott-legacy H5 to OME-Zarr",category:"Conversion",modality:"HCS",tags:["Yokogawa","Cellvoyager","3D"],input_types:{},output_types:{},docs_link:null,docs_info:`### Purpose
