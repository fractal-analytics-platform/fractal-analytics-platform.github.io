...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.2.1/abbott-0.2.1-py3-none-any.whl)
2. Run \`pip install abbott-0.2.1-py3-none-any.whl\`
`},{version:"0.2.1",name:"Compute Registration (warpfield)",category:"Registration",modality:"HCS",tags:["Multiplexing"],input_types:{},output_types:{},docs_link:"https://github.com/pelkmanslab/abbott",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.2.1/abbott-0.2.1-py3-none-any.whl)
2. Run \`pip install abbott-0.2.1-py3-none-any.whl\`
`},{version:"0.2.1",name:"Compute Channel Registration (elastix)",category:"Registration",modality:"HCS",tags:["Multiplexing"],input_types:{channels_registered:!1},output_types:{},docs_link:"https://github.com/pelkmanslab/abbott",docs_info:`### Purpose
- **Computes image-based registration** transformations for acquisitions in **HCS** OME-Zarr datasets using the elastix library.
- Needs Elastix profiles to configure the registration.
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.2.1/abbott-0.2.1-py3-none-any.whl)
2. Run \`pip install abbott-0.2.1-py3-none-any.whl\`
`},{version:"0.2.1",name:"Convert Cellvoyager Multiplexing to existing OME-Zarr",category:"Conversion",modality:"HCS",tags:["Yokogawa","Cellvoyager","2D","3D"],input_types:{},output_types:{},docs_link:"https://github.com/pelkmanslab/abbott",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.2.1/abbott-0.2.1-py3-none-any.whl)
2. Run \`pip install abbott-0.2.1-py3-none-any.whl\`
`},{version:"0.2.1",name:"Stardist Segmentation",category:"Segmentation",modality:null,tags:["Deep Learning","Convolutional Neural Network","Instance Segmentation","2D","3D"],input_types:{},output_types:{},docs_link:"https://github.com/pelkmanslab/abbott",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.2.1/abbott-0.2.1-py3-none-any.whl)
2. Run \`pip install abbott-0.2.1-py3-none-any.whl\`
`},{version:"0.2.1",name:"Seeded Watershed Segmentation",category:"Segmentation",modality:null,tags:["scikit-image","itk,","3D"],input_types:{},output_types:{},docs_link:"https://github.com/pelkmanslab/abbott",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.2.1/abbott-0.2.1-py3-none-any.whl)
2. Run \`pip install abbott-0.2.1-py3-none-any.whl\`
`},{version:"0.2.1",name:"Upsample Label Image",category:"Image Processing",modality:null,tags:["3D"],input_types:{},output_types:{},docs_link:"https://github.com/pelkmanslab/abbott",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.2.1/abbott-0.2.1-py3-none-any.whl)
2. Run \`pip install abbott-0.2.1-py3-none-any.whl\`
`},{version:"0.2.1",name:"Convert abbott-legacy H5 to OME-Zarr",category:"Conversion",modality:"HCS",tags:["Yokogawa","Cellvoyager","3D"],input_types:{},output_types:{},docs_link:"https://github.com/pelkmanslab/abbott",docs_info:`### Purpose
