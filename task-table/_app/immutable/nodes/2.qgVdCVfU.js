...
`+L),De&&Ut([W,K,te],H=>{L=Ct(L,H," ")}),d&&J?d.createHTML(L):L},e.setConfig=function(){let S=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};vt(S),bt=!0},e.clearConfig=function(){ve=null,bt=!1},e.isValidAttribute=function(S,u,w){ve||vt({});const O=j(S),V=j(u);return Bt(O,V,w)},e.addHook=function(S,u){typeof u=="function"&&At(F[S],u)},e.removeHook=function(S,u){if(u!==void 0){const w=Ys(F[S],u);return w===-1?void 0:Js(F[S],w,1)[0]}return ea(F[S])},e.removeHooks=function(S){F[S]=[]},e.removeAllHooks=function(){F=oa()},e}var fi=Da();const mi=[["abbott",[{pkg_name:"abbott",version:"0.1.0",task_list:[{version:"0.1.0",name:"Compute Registration (elastix)",category:"Registration",modality:"HCS",tags:["Multiplexing"],input_types:{},output_types:{},docs_link:"https://github.com/pelkmanslab/abbott",docs_info:`### Purpose
...
1. Download the wheel file from [this link](https://github.com/pelkmanslab/abbott/releases/download/v0.1.0/abbott-0.1.0-py3-none-any.whl)
2. Run \`pip install abbott-0.1.0-py3-none-any.whl\`
`}]}]],["apx_fractal_task_collection",[{pkg_name:"apx_fractal_task_collection",version:"0.4.7",task_list:[{version:"0.4.7",name:"Measure Features",category:"Measurement",modality:null,tags:["Textures","Intensity","Morphology","scikit-image","regionprops"],input_types:{},output_types:{},docs_link:"https://github.com/Apricot-Therapeutics/APx_fractal_task_collection",docs_info:`### Purpose
